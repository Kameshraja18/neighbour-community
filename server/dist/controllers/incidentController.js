...
exports.exportIncidents = exports.triggerSOS = exports.addIncidentNote = exports.updateIncidentStatus = exports.getIncidents = exports.createIncident = void 0;
const Incident_1 = __importDefault(require("../models/Incident"));
const urgency_1 = require("../utils/urgency");
...
const createIncident = async (req, res) => {
    try {
        ...
        const { score, level } = (0, urgency_1.calculateUrgency)(title, description, category);
        ...
        const incident = await Incident_1.default.create({
...
exports.addIncidentNote = addIncidentNote;
...
const exportIncidents = async (req, res) => {
    try {
        const incidents = await Incident_1.default.find({}).sort({ createdAt: -1 });
...
exports.exportIncidents = exportIncidents;
