...
const communityEventSchema = new mongoose_1.Schema({
    title: { type: String, required: true },
    description: { type: String, required: true },
    coverImage: { type: String },
    groupId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'CommunityGroup' },
...
exports.default = mongoose_1.default.model('CommunityEvent', communityEventSchema);
