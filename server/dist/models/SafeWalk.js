...
const safeWalkSchema = new mongoose_1.Schema({
    ...
    trackedBy: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'User' }],
...
exports.default = mongoose_1.default.model('SafeWalk', safeWalkSchema);
